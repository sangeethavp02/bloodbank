...
<li>Being treated for inherited blood disorders</li>
            ...
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Tips for blood donation</h4>
                   
                        <p class="card-text" style="padding-left:2%">
                        <ul><li>Check the blood stocks online </li><li>Drink lots of water </li><li>Avoid heavy lifting and vigorous exercise</li><li>Eat salty snack</li></ul></p></p>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card">
                    <h4 class="card-header">Who can give blood?</h4>
                        ...
                        <p class="card-text" style="padding-left:2%">
<ul>
<li>You are aged between 18 to 65</li>
<li>You weigh at least 50 kg</li>
<li>You must be in good health</li>
<li>Travel to areas where mosquito-borne infections are endemic</li>
</ul>
                    </p>
                </div>
            </div>
